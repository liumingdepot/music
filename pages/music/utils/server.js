...
const aUrl = 'https://www.kuwo.cn'
const bUrl = 'https://nmobi.kuwo.cn'


export const videoList = (params) => {
  return axios({
    url: `${aUrl}/search/searchMusicBykeyWord?vipver=1&client=kt&ft=music&cluster=0&strategy=2012&encoding=utf8&rformat=json&mobi=1&issubtitle=1&show_copyright_off=1&pn=${params.num}&rn=20&all=${params.key}`,
  })
}
...
export const getlyric = (params) => {
  return axios({
    url: `${aUrl}/openapi/v1/www/lyric/getlyric?musicId=${params.rid}&httpsStatus=1&reqId=d21938f0-9cd9-11f0-9861-2369cae1e1cc&plat=web_www&from=`,
  })
}